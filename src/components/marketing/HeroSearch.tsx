...
export default function HeroSearch() {
  ...
  return (
    <form
      ...
      className="w-full rounded-2xl border border-line bg-paper p-5 shadow-sm sm:p-6"
      aria-label="Search event spaces"
    >
      <p className="font-display text-lg font-semibold text-ink">Find a space</p>
      <p className="mt-1 text-sm text-ink-soft">Tell us the basics — we&apos;ll filter the results for you.</p>
      ...
      <button
        type="submit"
        className="mt-5 w-full rounded-full bg-wine px-6 py-3 text-sm font-semibold text-paper transition-colors hover:bg-wine-soft"
      >
        Search spaces
      </button>
    </form>
