...
import { acceptProposal, declineProposalWithNotification } from "@/lib/vendors/engagements";
...
import { formatExpiration, getEffectiveProposalStatus } from "@/lib/vendors/expiration";
...
type SortOption = "recommended" | "lowest_price" | "highest_rating" | "most_experience" | "newest" | "expiring_soon";
        ...
        {sorted.length === 0 ? (
          ...
          <ul className="space-y-4">
            {sorted.map((proposal) => {
              ...
              const effectiveStatus = getEffectiveProposalStatus(proposal, now);
              const isActionable = effectiveStatus === "submitted" || effectiveStatus === "shortlisted";
              return (
      ...
      >
        ...
        {confirmingAccept && (
          <p className="mt-3 text-sm text-ink-soft">
            This confirms a ${confirmingAccept.proposedAmount} engagement and its deliverables, notifies the vendor, and
            unlocks messaging.
