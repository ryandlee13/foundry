...
const VENDOR_SEEDS: VendorSeed[] = [
  ...
  { name: "Yuki Tanaka", email: "demo-vendor-10@example.com", skill: "lighting_technician", neighborhood: "Japantown", description: "Stage and ambient lighting design for concerts, panels, and corporate events.", years: 6, portfolioUrl: "https://youtube.com/demo-yuki-lighting", portfolioProviderHint: "Past rigs", remote: false, pricingModel: "day_rate", price: 700, experience: "experienced" },
...
const NEED_SEEDS: NeedSeed[] = [
  ...
  { organizerEmail: "demo-organizer-2@example.com", organizerName: "Marcus Webb", venueSlug: "redline-loft", skill: "lighting_technician", title: "Looking for a lighting tech — panel discussion", description: "Stage wash and ambient lighting for a 3-hour panel discussion with Q&A.", deliverables: "Stage wash, ambient wash, on-site operator", remote: false, daysFromNow: 14, budgetMin: 500, budgetMax: 800, positions: 1 },
